...
13. [Восстановление после ошибок](#восстановление-после-ошибок)
14. [Примеры программ](#примеры-программ)
15. [Справочная информация](#справочная-информация)
...
- **Автоматический вывод типов** - ключевое слово `var` позволяет компилятору вывести тип из инициализатора
